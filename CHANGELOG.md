...
### Changed
* Minimum requirements to run the plugin: PHP 7.4+, WP 6.0+, and EP 5.0.0+. Props [@felipeelia](https://github.com/felipeelia) via [#122](https://github.com/10up/ElasticPressLabs/pull/122).
