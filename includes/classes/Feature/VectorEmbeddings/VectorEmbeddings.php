...
class VectorEmbeddings extends Feature {
	...
	public function requirements_status() {
		...
		if ( Utils\is_epio() && ! \ElasticPress\get_container()->get( '\ElasticPress\ElasticPressIo' )->is_service_available( 'vectorEmbeddings' ) ) {
	...
	public function set_settings_schema() {
		...
		$this->settings_schema = [
			...
			[
				'type'            => 'field_group',
				'key'             => 'ep_embeddings_openai',
				'label'           => __( 'OpenAI Connection Details', 'elasticpress-labs' ),
				'requires_fields' => [
					'conditions' => [
						'ep_embeddings_generator' => 'openai',
					],
